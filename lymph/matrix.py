...
def generate_transition(instance: models.Unilateral) -> np.ndarray:
    ...
    transition_matrix = np.ones(shape=(instance.n_mixture_components, num_states**num_lnls, num_states**num_lnls))
    ...
    for i, lnl in enumerate(instance.graph.lnls.values()):
        ...
        lnl_transition_matrix = expand_to_dimension(lnl_transition_matrix, instance.n_mixture_components)
